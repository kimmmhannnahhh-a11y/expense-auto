...
// 결산산입부서 드롭다운 목록 — 다우 등록폼 select 옵션과 100% 동일해야 selectOption 성공함.
// (실측: 2026-06-11 doc/new/2575 폼에서 추출)
export const DEPARTMENTS = [
  "경영지원실", "공사", "대외팀", "대성", "마케팅부",
  "영업부(영업지원팀)", "영업부(시흥영업1팀)", "영업부(시흥영업2팀)", "영업부(천안영업/청약)",
  "우신 기술사업부", "우신 영업사업부", "우성 영업사업부",
  "유통사업부", "모바일 유통사업부", "통합(공용)",
  "구로현장팀(구)", "시흥청약팀(구)", "영업운영팀(구)", "부천영업팀(구)", "모바일관리팀(구)",
];
